...
site = "https://swapi.dev/api/people/?search=&page=1"
...
# inp = input("“Your path you must decide“ - Yoda' ['Make a choice', 'People', 'Planets', 'Species', 'Starships', 'Vehicles', 'Films']").lower()
...
#     if page+sel not in all_urls:
#         all_urls.append(right_url)
#     return url


# if "next" in get_url(site, inp):
#     #print("yes")
#     next_ = True
#     next_url = get_url(site, inp)["next"]
...
# def get_film(page, sel):
#     right_url = page+sel
#     url = req.get(right_url).json()["results"]
#     for i in range(len(url)):
#         films.append(url[i]["title"])
#     pass
...
with col2:
    ...
    if inp == "People":
        ...
        inp = st.selectbox('“You will find only what you bring in.“ - Yoda', planets)
    elif inp == "Species":
        inp = st.selectbox('“You will find only what you bring in.“ - Yoda', species)
    elif inp == "Starships":
        inp = st.selectbox('“You will find only what you bring in.“ - Yoda', starships)
    elif inp == "Vehicles":
        inp = st.selectbox('“You will find only what you bring in.“ - Yoda', vehicles)
    elif inp == "Films":
        inp = st.selectbox('“You will find only what you bring in.“ - Yoda', films)
