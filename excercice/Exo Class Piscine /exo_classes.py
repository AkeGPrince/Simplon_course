...
# Instruction : Codez la méthode "whaaat" de la class "Fonction"
# afin que celle ci retourne les resultats "#"

# f = Fonction()
# print(f.whaaat(2,2,0))           #-> 1.0
# print(f.whaaat(2,2,1))           #-> 2.0
# print(f.whaaat(2,2,2))           #-> 3.0
# print(f.whaaat(2,1))             #-> 3.0
# print(f.whaaat(b=2,a=1))         #-> 1.5
# print(f.whaaat(b=2,a=1,c=0))     #-> 0.5
# print(f.whaaat(2))               #-> multiplier() missing 1 required positional argument
